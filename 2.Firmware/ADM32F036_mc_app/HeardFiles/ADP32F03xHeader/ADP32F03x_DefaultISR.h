//###########################################################################
//
// FILE:    ADP32F03x_DefaultIsr.h
//
// TITLE:   ADP32F03x Devices Default Interrupt Service Routines Definitions.
//
//###########################################################################

#ifndef ADP32F03x_DEFAULT_ISR_H
#define ADP32F03x_DEFAULT_ISR_H
...
// This default vector table is found in the ADP32F03x_PieVect.h
// file.
//
...
__interrupt void CANFD_ISR(void);          // CANFD_ISR
__interrupt void DUL_PAR_int_ISR(void);    // DUL_PAR_int_ISR
__interrupt void SING_int_ISR(void);       // SING_int_ISR
__interrupt void CANFD_2_ISR(void);         // CANFD_ISR
...
#endif    // end of ADP32F03x_DEFAULT_ISR_H definition
