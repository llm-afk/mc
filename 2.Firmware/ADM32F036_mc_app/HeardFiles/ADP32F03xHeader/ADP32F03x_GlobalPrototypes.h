//###########################################################################
//
// FILE:   ADP32F03x_GlobalPrototypes.h
//
// TITLE:  Global prototypes for ADP32F03x Examples
//
//###########################################################################

#ifndef ADP32F03x_GLOBALPROTOTYPES_H
#define ADP32F03x_GLOBALPROTOTYPES_H
...
#endif // endif DSP32_ECANA
extern void InitCanfd();
extern void InitCanfdGpio(void);
...
#endif // endif DSP32_COMP2
#if DSP32_COMP2
extern void InitComp3Gpio(void);
#endif // endif DSP32_COMP3
...
// DSP32 examples will use these to relocate code from one LOAD location
...
#endif   // - end of ADP32F03x_GLOBALPROTOTYPES_H
