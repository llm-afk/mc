...
;//
;//  1 - update the CPU clock speed in the ADP32F03x_Examples.h
;//    file. For example:
;//    #define CPU_RATE 16.667L // for a 60MHz CPU clock speed
;//
;//  2 - Call this function by using the DELAY_US(A) macro
;//    that is defined in the ADP32F03x_Examples.h file.  This macro
...
;//
       ...
       .def _ADP32F03x_usDelay
       .sect "ramfuncs"

        .global  __ADP32F03x_usDelay
_ADP32F03x_usDelay:
        SUB    ACC,#1
        BF     _ADP32F03x_usDelay,GEQ    ;; Loop if ACC >= 0
        LRETR 
