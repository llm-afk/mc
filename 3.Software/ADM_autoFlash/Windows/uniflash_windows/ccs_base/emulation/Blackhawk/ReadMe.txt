Blackhawk(tm) CCS v9 Emulation Drivers
...
===================================
2019 (c) EWA Technologies, Inc.


=> VERSION

9.0.0.002              29 July 2019


=> WHAT's NEW

Built using InstallBuilder Version: 19.7.1 (2019-07-20)

	** REBUILT INSTALLERS USING INSTALLBUILDER 19.7  **
	** TO FIX INSTALLBUILDER WINDOWS VULNERABILITY.  **
...
9.0.0.001              18 January 2019
Built using InstallBuilder Version: 18.12.0 (2018-12-31)
[LINUX Updates]
	- No changes.
[WIN32 Updates]
	- Enabled 64-bit installer mode.  This will not install on 32-bit systems.
	- Updated XDS560v2 binaries to 64-bit
	- Removed XDS510 emulator support

6.2.0.011              24 September 2018
Built using InstallBuilder Version: 18.7.0 (2018-07-25)
[LINUX Updates]
	- No changes.
[WIN32 Updates]
	- Updated Windows Device Driver installer v1.18.08.06.
		Created Windows 10 package for Bh560v2 drivers that
		supports secure boot mode.
