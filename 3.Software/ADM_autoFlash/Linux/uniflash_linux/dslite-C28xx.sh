...
if [ "$#" -eq 0 ]; then
	args=(\"$scriptDir\"/ccs_base/DebugServer/bin/DSLite $MODE -c user_files/configs/f28035.ccxml -l user_files/settings/generated.ufsettings -s VerifyAfterProgramLoad="No verification" )
